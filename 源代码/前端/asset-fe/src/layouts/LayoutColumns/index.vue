...
<template>
  <el-container class="layout">
    ...
    <el-aside :class="{ 'not-aside': !subMenuList.length }" :style="{ width: isCollapse ? '65px' : '210px' }">
      <div class="logo flx-center">
        <!-- <span v-if="subMenuList.length && isCollapse" class="logo-text">{{ "资" }}</span> -->
        <img v-if="subMenuList.length && isCollapse" class="logo-img" src="@/assets/images/logo.png" alt="logo" />
        <img v-else style="width: 190px" class="logo-img" src="@/assets/images/logo-img.jpg" alt="logo" />
      </div>
      <el-scrollbar>
        <el-menu
          :router="false"
