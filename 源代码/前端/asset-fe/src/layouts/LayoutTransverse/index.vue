  ...
  <el-container class="layout">
    <el-header>
      <div class="logo flx-center">
        <img style="width: 210px; margin-left: 20px" class="logo-img" src="@/assets/images/logo-img.jpg" alt="logo" />
        ...
        <template v-for="subItem in menuList" :key="subItem.path">
          <el-sub-menu v-if="subItem.children?.length" :key="subItem.path" :index="subItem.path + 'el-sub-menu'">
            <template #title>
              ...
              <svg-icon :name="subItem.meta.icon" v-if="subItem.meta.icon"></svg-icon>
