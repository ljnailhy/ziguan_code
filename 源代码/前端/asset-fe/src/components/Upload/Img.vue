  ...
  <div class="upload-box">
    ...
    >
      <template v-if="imageUrl">
        <img :src="'/minio' + imageUrl" class="upload-image" />
    ...
    <el-image-viewer v-if="imgViewVisible" :url-list="['/minio' + imageUrl]" @close="imgViewVisible = false" />
  </div>
</template>
...
const handleHttpUpload = async (options: UploadRequestOptions) => {
  ...
  try {
    ...
    emit("update:imageUrl", data[0].fileUrl);
