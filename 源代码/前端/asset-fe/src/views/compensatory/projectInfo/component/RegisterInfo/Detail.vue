<template>
  <el-dialog v-model="dialogVisible" title="查看" draggable width="800px">
    <vz-card title="基本信息">
      <el-form ref="ruleFormRef" label-width="110px" label-suffix=" :" scroll-to-error :disabled="true" :model="form">
        <el-row :gutter="35">
...
<script setup lang="tsx" name="RegisterInfoDetail">
import { ref } from "vue";
