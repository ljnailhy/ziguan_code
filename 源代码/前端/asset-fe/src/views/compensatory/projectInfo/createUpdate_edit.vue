  ...
  <div>
    ...
    >
        ...
        <el-row :gutter="35">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="8" class="mb20">
            <el-form-item label="项目状态" prop="projectState">
              <vz-select
                dict-type="PROJECT_STATE"
                v-model="form!.projectState"
                :dict-value="form!.projectState"
                style="width: 100%"
              ></vz-select>
            </el-form-item>
          </el-col>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="8" class="mb20">
            <el-form-item label="项目名称" prop="subjectName">
              <el-input
                v-model="form!.subjectInfoRequest.subjectName"
                :value="form!.subjectInfoRequest.subjectName"
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="16" class="mb20">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="8" class="mb20">
            <el-form-item label="律所" prop="lawyerName">
              <vz-law-firm-info
      ...
      <!-- <vz-card title="分险信息">
        <el-row :gutter="35">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="8" class="mb20">
            <el-form-item label="分险比例（债权人）" prop="dividedInsuranceDebtor">
              <vz-input-unit
                v-model="form!.dividedInsuranceDebtor"
                :value="form!.dividedInsuranceDebtor"
                placeholder="请输入分险比例（债权人）"
                text="%"
                clearable
              ></vz-input-unit>
            </el-form-item>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="8" class="mb20">
            <el-form-item label="分险比例（原担保）" prop="dividedInsuranceSecurity">
              <vz-input-unit
                v-model="form!.dividedInsuranceSecurity"
                :value="form!.dividedInsuranceSecurity"
                placeholder="请输入分险比例（原担保）"
                text="%"
                clearable
              ></vz-input-unit>
            </el-form-item>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="8" class="mb20">
            <el-form-item label="分险比例（再担保）" prop="dividedInsuranceAgainSecurity">
              <vz-input-unit
                v-model="form!.dividedInsuranceAgainSecurity"
                :value="form!.dividedInsuranceAgainSecurity"
                placeholder="请输入分险比例（再担保）"
                text="%"
                clearable
              ></vz-input-unit>
            </el-form-item>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="8" class="mb20">
            <el-form-item label="分险比例（其他）" prop="dividedInsuranceOther">
              <vz-input-unit
                v-model="form!.dividedInsuranceOther"
                :value="form!.dividedInsuranceOther"
                placeholder="请输入分险比例（其他）"
                text="%"
                clearable
              ></vz-input-unit>
            </el-form-item>
...
const dateChange = () => {
  form.value.compensationDate = getEarliestDate(projectLoanRef.value.data.map(item => item.compensationDate));
};
const moneyInput = () => {
...
const countFun = () => {
  //分录的金额合计
  const assetMoneyData = JSON.parse(JSON.stringify(projectLoanRef.value.data));
...
const handleSave = async () => {
  ...
  if (form.value!.manage && form.value!.manage.length) {
    form.value!.manage = form.value!.manage.toString();
  }
  try {
    ...
    // form.value.revePropertyInfoRequest = [...newArr, ...newArr1];
