...
export type TypeProps = "index" | "selection" | "radio" | "expand" | "sort" | "user" | "area" | "year" | "month" | "date" | "datetime" | "boolean" | "money" | "org" | "dictionary";
...
export interface ColumnProps<T = any> extends Partial<Omit<TableColumnCtx<T>, "type" | "children" | "renderCell" | "renderHeader">> {
    ...
    user?: boolean | Ref<boolean>;
    date?: boolean | Ref<boolean>;
    area?: boolean | Ref<boolean>;
    org?: boolean | Ref<boolean>;
    money?: boolean | Ref<boolean>;
...
export type VzTableInstance = Omit<InstanceType<typeof VzTable>, keyof ComponentPublicInstance | keyof VzTableProps>;
export {};
