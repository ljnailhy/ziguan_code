...
@ApiModel(description = "运营信息表分页入参")
public class OperationInfoPageRequest extends OperationInfoRequest {
  ...
  @ApiModelProperty("运营时间范围")
  private List<Date> operationDateRange;
