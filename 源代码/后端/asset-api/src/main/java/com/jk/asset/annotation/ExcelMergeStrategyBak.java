...
// */
//public class ExcelMergeStrategyBak implements RowWriteHandler {
//
//    /**
//     * 主键下标
//     */
...
//
//    public ExcelMergeStrategyBak(Class<?> elementType) {
...
//        if (lastRow.getCell(primaryKeyIndex).getNumericCellValue() != row.getCell(primaryKeyIndex).getNumericCellValue()) {
//            return;
//        }
...
//            ExcelMerge excelMerge = fields[i].getAnnotation(ExcelMerge.class);
//            // 判断是否需要合并
//            if (null == excelMerge) {
//                continue;
//            }
...
//                    if (primaryKeyIndex == null && excelMerge.isPrimaryKey()) {
//                        primaryKeyIndex = i;
//                    }
//                    if (excelMerge.merge()) {
