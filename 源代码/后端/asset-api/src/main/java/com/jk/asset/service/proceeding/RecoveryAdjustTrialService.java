 ...
 */
public interface RecoveryAdjustTrialService {

  String CONTEXT = "/recovery/adjust/trial";
  ...
  @PostMapping(CONTEXT)
  Result<RecoveryAdjustTrialDTO> add(@RequestBody RecoveryAdjustTrialRequest request);
  ...
  @PutMapping(CONTEXT)
  Result<RecoveryAdjustTrialDTO> update(@RequestBody RecoveryAdjustTrialRequest request);
  ...
  Result<RecoveryAdjustTrialDTO> submit(@RequestBody RecoveryAdjustTrialRequest request);
  ...
  Result<RecoveryAdjustTrialDTO> writeBackProject(@ApiParam("主键") @PathVariable Long id);
  ...
  Result<RecoveryAdjustTrialDTO> findById(@ApiParam("主键") @PathVariable Long id);
  ...
  Result<List<RecoveryAdjustTrialDTO>> findByLitigationId(@ApiParam("诉讼id") @PathVariable Long litigationId);
  ...
  Result<List<RecoveryAdjustTrialDTO>> findAll(@ApiParam("当前页码") @RequestParam(defaultValue = "1") Integer current,
      @ApiParam("每页大小") @RequestParam(defaultValue = "50") Integer size,
      @RequestBody RecoveryAdjustTrialPageRequest request);
