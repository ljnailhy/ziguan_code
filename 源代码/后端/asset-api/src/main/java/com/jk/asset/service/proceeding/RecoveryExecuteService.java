 ...
 */
public interface RecoveryExecuteService {

  String CONTEXT = "/recovery/execute";

  /**
   * 新增
   *
   * @param request 执行信息	入参
  ...
  @PostMapping(CONTEXT)
  Result<RecoveryExecuteDTO> add(@RequestBody RecoveryExecuteRequest request);
  ...
  @PutMapping(CONTEXT)
  Result<RecoveryExecuteDTO> update(@RequestBody RecoveryExecuteRequest request);
  ...
  Result<RecoveryExecuteDTO> submit(@RequestBody RecoveryExecuteRequest request);
  ...
  Result<RecoveryExecuteDTO> writeBackProject(@ApiParam("主键") @PathVariable Long id);
  ...
  Result<RecoveryExecuteDTO> findById(@ApiParam("主键") @PathVariable Long id);
  ...
  Result<List<RecoveryExecuteDTO>> findAll(@ApiParam("当前页码") @RequestParam(defaultValue = "1") Integer current,
      @ApiParam("每页大小") @RequestParam(defaultValue = "50") Integer size,
      @RequestBody RecoveryExecutePageRequest request);
